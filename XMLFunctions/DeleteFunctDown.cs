...
{
     public class DeleteFunctDown
        {

            public static async Task DeleteDownPeriod(int docId, string targetBegin, string targetEnd)
            {
                ...
                string query = @"
                    ...
                    SET dataxml = XMLPARSE(DOCUMENT 
                        REGEXP_REPLACE(
                            ...
                            '<ns3:end>' || @targetEnd || '</ns3:end>\s*</ns3:period>\s*' ||
